...
import br.com.movieflix.sevirce.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest request) {
        ...
        String gerenatedToken = tokenService.generateToken(user);
        return ResponseEntity.ok(new LoginResponse(gerenatedToken));
    }
}
